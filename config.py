...
BOT_USERNAME = getenv("BOT_USERNAME", "NINJA_MUSIC0_BOT")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "NINJA2_MUSIC")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "ninjaaa_bots")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "update_music0")
OWNER_NAME = getenv("OWNER_NAME", "dont_run") 
DEV_NAME = getenv("DEV_NAME", "dont_run")
